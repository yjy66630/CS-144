...
ParseResult
EthernetHeader::parse(NetParser& p)
{
...
string
EthernetHeader::serialize() const
{
    string ret;
    ret.reserve(LENGTH);
...
string
to_string(const EthernetAddress address)
{
    stringstream ss{};
...
string
EthernetHeader::to_string() const
{
    stringstream ss{};
    ...
    ss << ", type=";
    switch (type) {
        case TYPE_IPv4: ss << "IPv4"; break;
        case TYPE_ARP: ss << "ARP"; break;
        default: ss << "[unknown type " << hex << type << "!]"; break;
    }
