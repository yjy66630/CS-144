...
public:
    ...
    //! Attempts to read and parse an IPv4 datagram containing a TCP segment related to the current
    //! connection
...
public:
    ...
    //! Attempts to read and parse an Ethernet frame containing an IPv4 datagram that contains a TCP
    //! segment
