...
bool
TCPState::operator==(const TCPState& other) const
{
...
TCPState::TCPState(const TCPSender& sender, const TCPReceiver& receiver, const bool active,
                   const bool linger) :
...
string
TCPState::state_summary(const TCPReceiver& receiver)
{
...
string
TCPState::state_summary(const TCPSender& sender)
{
