...
public:
    ...
    //! \brief Construct a TCPState given a sender, a receiver, and the TCPConnection's active and
    //! linger bits
    TCPState(const TCPSender& sender, const TCPReceiver& receiver, const bool active,
             const bool linger);
...
const std::string ERROR = "ERROR: error (connection was reset)";
const std::string LISTEN = "LISTEN: waiting for stream to begin (listening for SYN)";
const std::string SYN_RECV = "SYN_RECV: stream started";
const std::string FIN_RECV = "FIN_RECV: stream finished";
}   // namespace TCPReceiverStateSummary

namespace TCPSenderStateSummary {
const std::string ERROR = "ERROR: error (connection was reset)";
const std::string CLOSED = "CLOSED: waiting for stream to begin (no SYN sent)";
const std::string SYN_SENT = "SYN_SENT: stream started but nothing acknowledged";
const std::string SYN_ACKED = "SYN_ACKED: stream ongoing";
const std::string FIN_SENT = "FIN_SENT: stream finished (FIN sent) but not fully acknowledged";
const std::string FIN_ACKED = "FIN_ACKED: stream finished and fully acknowledged";
}   // namespace TCPSenderStateSummary
