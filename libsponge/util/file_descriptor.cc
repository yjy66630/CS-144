...
void
FileDescriptor::read(std::string& str, const size_t limit)
{
...
string
FileDescriptor::read(const size_t limit)
{
    string ret;
...
size_t
FileDescriptor::write(BufferViewList buffer, const bool write_all)
{
...
void
FileDescriptor::set_blocking(const bool blocking_state)
{
