...
public:
    ...
    string
    message(const int return_value) const noexcept override
    {
...
make_hints(const int ai_flags, const int ai_family)
{
...
Address
Address::from_ipv4_numeric(const uint32_t ip_address)
{
    sockaddr_in ipv4_addr{};
