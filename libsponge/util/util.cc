...
//! ~~~
int
SystemCall(const char* attempt, const int return_value, const int errno_mask)
{
...
int
SystemCall(const string& attempt, const int return_value, const int errno_mask)
{
...
void
InternetChecksum::add(std::string_view data)
{
...
void
hexdump(const uint8_t* data, const size_t len, const size_t indent)
{
...
//! \param[in] indent is the number of spaces to indent
void
hexdump(const char* data, const size_t len, const size_t indent)
{
