...
public:
    ...
    std::queue<InternetDatagram>&
    datagrams_out()
    {
        return _datagrams_out;
    }
};
...
public:
    ...
    size_t
    add_interface(AsyncNetworkInterface&& interface)
    {
    ...
    interface(const size_t N)
    {
        return _interfaces.at(N);
    }

    //! Add a route (a forwarding rule)
    void add_route(const uint32_t route_prefix, const uint8_t prefix_length,
