...
struct SenderTestStep
{
    ...
    {
        return "SenderTestStep";
    }
    virtual void
    execute(TCPSender&, std::deque<TCPSegment>&) const
    {
    }
...
struct ExpectState : public SenderExpectation
{
    ...
    void
    execute(TCPSender& sender, std::deque<TCPSegment>&) const
    {
...
struct ExpectNoSegment : public SenderExpectation
{
    ...
    void
    execute(TCPSender&, std::deque<TCPSegment>& segments) const
    {
...
struct Tick : public SenderAction
{
    ...
    Tick&
    with_max_retx_exceeded(bool max_retx_exceeded_)
    {
...
struct ExpectSegment : public SenderExpectation
{
    ...
    ExpectSegment&
    with_ackno(WrappingInt32 ackno_)
    {
        ackno = ackno_;
        return *this;
    }
    ...
    ExpectSegment&
    with_payload_size(size_t payload_size_)
    {
...
public:
    ...
    void
    execute(const SenderTestStep& step)
    {
        try {
