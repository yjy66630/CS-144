...
void
check_equivalent_segments(const TCPSegment& a, const TCPSegment& b)
{
...
void
SendEquivalenceChecker::submit_a(TCPSegment& seg)
{
    if (not bs.empty()) {
...
void
SendEquivalenceChecker::submit_b(TCPSegment& seg)
{
    if (not as.empty()) {
...
void
SendEquivalenceChecker::check_empty() const
{
    if (not as.empty()) {
        stringstream s{};
