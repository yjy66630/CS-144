...
inline void
show_ethernet_frame(const uint8_t* pkt, const struct pcap_pkthdr& hdr)
{
...
inline bool
compare_tcp_headers_nolen(const TCPHeader& h1, const TCPHeader& h2)
{
...
inline bool
compare_tcp_headers(const TCPHeader& h1, const TCPHeader& h2)
{
