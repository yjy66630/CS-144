...
ByteStreamTestStep::operator std::string() const
{
    return "ByteStreamTestStep";
}

void
ByteStreamTestStep::execute(ByteStream&) const
{
}
...
template<typename T>
ByteStreamExpectationViolation
ByteStreamExpectationViolation::property(const std::string& property_name, const T& expected,
                                         const T& actual)
{
...
ByteStreamExpectation::operator std::string() const
{
    return "Expectation: " + description();
}

std::string
ByteStreamExpectation::description() const
{
    return "description missing";
}

void
ByteStreamExpectation::execute(ByteStream&) const
{
}
...
ByteStreamAction::operator std::string() const
{
    return "     Action: " + description();
}

std::string
ByteStreamAction::description() const
{
    return "description missing";
}

void
ByteStreamAction::execute(ByteStream&) const
{
}
...
void
ByteStreamTestHarness::execute(const ByteStreamTestStep& step)
{
    try {
...
// EndInput
std::string
EndInput::description() const
{
    return "end input";
}
void
EndInput::execute(ByteStream& bs) const
{
    bs.end_input();
}
...
{
    return "write \"" + _data + "\" to the stream";
}
void
Write::execute(ByteStream& bs) const
{
...
std::string
Pop::description() const
{
    return "pop " + to_string(_len);
}
void
Pop::execute(ByteStream& bs) const
{
    bs.pop_output(_len);
}
...
std::string
InputEnded::description() const
{
    return "input_ended: " + to_string(_input_ended);
}
void
InputEnded::execute(ByteStream& bs) const
{
...
std::string
BufferEmpty::description() const
{
    return "buffer_empty: " + to_string(_buffer_empty);
}
void
BufferEmpty::execute(ByteStream& bs) const
{
...
std::string
Eof::description() const
{
    return "eof: " + to_string(_eof);
}
void
Eof::execute(ByteStream& bs) const
{
    auto eof = bs.eof();
    if (eof != _eof) {
...
std::string
BufferSize::description() const
{
    return "buffer_size: " + to_string(_buffer_size);
}
void
BufferSize::execute(ByteStream& bs) const
{
...
std::string
RemainingCapacity::description() const
{
    return "remaining_capacity: " + to_string(_remaining_capacity);
}
void
RemainingCapacity::execute(ByteStream& bs) const
{
...
std::string
BytesWritten::description() const
{
    return "bytes_written: " + to_string(_bytes_written);
}
void
BytesWritten::execute(ByteStream& bs) const
{
...
std::string
BytesRead::description() const
{
    return "bytes_read: " + to_string(_bytes_read);
}
void
BytesRead::execute(ByteStream& bs) const
{
...
std::string
Peek::description() const
{
    return "\"" + _output + "\" at the front of the stream";
}
void
Peek::execute(ByteStream& bs) const
{
