...
struct ExpectNoData : public TCPExpectation
{
    ...
    void
    execute(TCPTestHarness& harness) const
    {
        if (harness.can_read()) {
...
static void
append_data(std::ostream& os, std::string_view data)
{
    os << "\"";
...
struct ExpectData : public TCPExpectation
{
    ...
    ExpectData&
    with_data(const std::string& data_)
    {
        data = data_;
        return *this;
    }
...
struct ExpectSegment : public TCPExpectation
{
    ...
    virtual TCPSegment
    expect_seg(TCPTestHarness& harness) const
    {
        if (not harness.can_read()) {
...
struct Write : public TCPAction
{
    ...
    TCPAction&
    with_bytes_written(size_t bytes_written)
    {
