...
class Host
{
    ...
    bool
    expecting(const InternetDatagram& expected) const
    {
    ...
    void
    remove_expectation(const InternetDatagram& expected)
    {
...
public:
    ...
    InternetDatagram
    send_to(const Address& destination, const uint8_t ttl = 64)
    {
        InternetDatagram dgram;
    ...
    void
    expect(const InternetDatagram& expected)
    {
...
private:
    ...
    void
    exchange_frames(const string& x_name, AsyncNetworkInterface& x, const string& y_name,
    ...
    void
    deliver(const string& src_name, const queue<EthernetFrame>& src, const string& dst_name,
