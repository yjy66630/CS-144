...
static void
show_usage(const char* arg0, const char* errmsg)
{
...
static void
check_arg(char* arg0, int argc, int curr, const char* errmsg)
{
    if (curr + 1 >= argc) {
...
static int
parse_arguments(int argc, char** argv, char** dev_ptr)
{
    int curr = 1;
    while (curr < argc) {
...
static int
process_ipv4_ipv6(int len, const uint8_t* data, string& src_addr, string& dst_addr)
{
